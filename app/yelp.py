...
SEARCH_LIMIT = 50
class yelp:
    def ask(self, host, path, api_key, url_params=None):
    ...
    def search(self, keyword, location):
        ...
        print(type(self.ask(API_HOST, SEARCH_PATH, API_KEY, url_params=url_params)))
        return self.ask(API_HOST, SEARCH_PATH, API_KEY, url_params=url_params)
    ...
    def getReviews(self, business):
    	businessID = business['id']
    	path = BUSINESS_PATH + businessID + '/reviews'
    	response = self.ask(API_HOST, path, API_KEY, None)
    	return self.ask(API_HOST, path, API_KEY, None)
